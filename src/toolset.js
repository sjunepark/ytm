...
async function postNexacroXml(endpoint, body, context = {}) {
  ...
  if (typeof fetchImpl !== "function") {
    throw new KisnetYtmError({ code: "invalid_request", reason: "No fetch implementation is available. Use Node 18+ or pass context.fetch.", recoveryHint: "Run this package on Node.js 18 or newer.", recoveryAction: "inspect_tool_help", recoverable: true, retryable: false });
  }
